...
static const _GetAgentState_Request_type_support_symbol_names_t _GetAgentState_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_srvs, srv, GetAgentState_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pedsim_srvs, srv, GetAgentState_Request)),
  }
};
...
{
  return &::pedsim_srvs::srv::rosidl_typesupport_cpp::GetAgentState_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pedsim_srvs, srv, GetAgentState_Request)() {
  return get_message_type_support_handle<pedsim_srvs::srv::GetAgentState_Request>();
}
...
static const _GetAgentState_Response_type_support_symbol_names_t _GetAgentState_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_srvs, srv, GetAgentState_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pedsim_srvs, srv, GetAgentState_Response)),
  }
};
...
{
  return &::pedsim_srvs::srv::rosidl_typesupport_cpp::GetAgentState_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pedsim_srvs, srv, GetAgentState_Response)() {
  return get_message_type_support_handle<pedsim_srvs::srv::GetAgentState_Response>();
}
...
static const _GetAgentState_type_support_symbol_names_t _GetAgentState_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_srvs, srv, GetAgentState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pedsim_srvs, srv, GetAgentState)),
  }
};
...
{
  return &::pedsim_srvs::srv::rosidl_typesupport_cpp::GetAgentState_service_type_support_handle;
}
