...
static const _SetAgentState_Request_type_support_symbol_names_t _SetAgentState_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_srvs, srv, SetAgentState_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pedsim_srvs, srv, SetAgentState_Request)),
  }
};
...
{
  return &::pedsim_srvs::srv::rosidl_typesupport_cpp::SetAgentState_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pedsim_srvs, srv, SetAgentState_Request)() {
  return get_message_type_support_handle<pedsim_srvs::srv::SetAgentState_Request>();
}
...
static const _SetAgentState_Response_type_support_symbol_names_t _SetAgentState_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_srvs, srv, SetAgentState_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pedsim_srvs, srv, SetAgentState_Response)),
  }
};
...
{
  return &::pedsim_srvs::srv::rosidl_typesupport_cpp::SetAgentState_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pedsim_srvs, srv, SetAgentState_Response)() {
  return get_message_type_support_handle<pedsim_srvs::srv::SetAgentState_Response>();
}
...
static const _SetAgentState_type_support_symbol_names_t _SetAgentState_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_srvs, srv, SetAgentState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pedsim_srvs, srv, SetAgentState)),
  }
};
...
{
  return &::pedsim_srvs::srv::rosidl_typesupport_cpp::SetAgentState_service_type_support_handle;
}
