...
#include "pedsim_msgs/msg/detail/agent_state__rosidl_typesupport_fastrtps_c.h"
...
#include "pedsim_msgs/msg/detail/agent_force__functions.h"  // forces
#include "rosidl_runtime_c/string.h"  // social_state
#include "rosidl_runtime_c/string_functions.h"  // social_state
...
using _AgentState__ros_msg_type = pedsim_msgs__msg__AgentState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: social_state
  {
    const rosidl_runtime_c__String * str = &ros_message->social_state;
  ...
  // Field name: forces
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, pedsim_msgs, msg, AgentForce
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: social_state
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->social_state.data) {
      rosidl_runtime_c__String__init(&ros_message->social_state);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->social_state,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'social_state'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_pedsim_msgs__msg__AgentForce(
...
static uint32_t _AgentState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pedsim_msgs__msg__AgentState(
  ...
  size_t current_alignment)
{
  ...
  // member: forces
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_pedsim_msgs__msg__AgentForce(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = pedsim_msgs__msg__AgentState;
    is_plain =
      (
...
static size_t _AgentState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pedsim_msgs__msg__AgentState(
