...
#include "pedsim_msgs/msg/detail/tracked_person__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedPerson__ros_msg_type = pedsim_msgs__msg__TrackedPerson;
...
static uint32_t _TrackedPerson__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pedsim_msgs__msg__TrackedPerson(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pedsim_msgs__msg__TrackedPerson;
    is_plain =
      (
...
static size_t _TrackedPerson__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pedsim_msgs__msg__TrackedPerson(
