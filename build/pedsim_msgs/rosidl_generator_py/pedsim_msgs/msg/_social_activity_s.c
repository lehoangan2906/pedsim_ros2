...
bool pedsim_msgs__msg__social_activity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pedsim_msgs.msg._social_activity.SocialActivity", full_classname_dest, 47) == 0);
  }
  pedsim_msgs__msg__SocialActivity * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of SocialActivity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pedsim_msgs.msg._social_activity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SocialActivity");
