...
static const _LineObstacles_type_support_symbol_names_t _LineObstacles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_msgs, msg, LineObstacles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pedsim_msgs, msg, LineObstacles)),
  }
};
...
{
  return &::pedsim_msgs::msg::rosidl_typesupport_cpp::LineObstacles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pedsim_msgs, msg, LineObstacles)() {
  return get_message_type_support_handle<pedsim_msgs::msg::LineObstacles>();
}
