...
#include "pedsim_msgs/msg/detail/tracked_group__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pedsim_msgs::msg::TrackedGroup & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pedsim_msgs::msg::TrackedGroup & ros_message)
{
  // Member: group_id
  cdr >> ros_message.group_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pedsim_msgs::msg::TrackedGroup;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pedsim_msgs::msg::TrackedGroup *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pedsim_msgs::msg::TrackedGroup *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrackedGroup__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pedsim_msgs::msg::TrackedGroup *>(
...
static size_t _TrackedGroup__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrackedGroup(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrackedGroup__callbacks = {
  "pedsim_msgs::msg",
  "TrackedGroup",
...
static rosidl_message_type_support_t _TrackedGroup__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrackedGroup__callbacks,
...
{
  return &pedsim_msgs::msg::typesupport_fastrtps_cpp::_TrackedGroup__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pedsim_msgs, msg, TrackedGroup)() {
  return &pedsim_msgs::msg::typesupport_fastrtps_cpp::_TrackedGroup__handle;
}
