...
bool pedsim_msgs__msg__line_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pedsim_msgs.msg._line_obstacle.LineObstacle", full_classname_dest, 43) == 0);
  }
  pedsim_msgs__msg__LineObstacle * ros_message = _ros_message;
  {  // start
...
{
  /* NOTE(esteve): Call constructor of LineObstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pedsim_msgs.msg._line_obstacle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LineObstacle");
