...
bool pedsim_msgs__msg__agent_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pedsim_msgs.msg._agent_state.AgentState", full_classname_dest, 39) == 0);
  }
  pedsim_msgs__msg__AgentState * ros_message = _ros_message;
  {  // header
  ...
  {  // social_state
    PyObject * field = PyObject_GetAttrString(_pymsg, "social_state");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->social_state, PyBytes_AS_STRING(encoded_field));
  ...
  {  // forces
    ...
    if (!pedsim_msgs__msg__agent_force__convert_from_py(field, &ros_message->forces)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * pedsim_msgs__msg__agent_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pedsim_msgs.msg._agent_state");
  ...
  {  // social_state
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->social_state.data,
      strlen(ros_message->social_state.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "social_state", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // forces
    PyObject * field = NULL;
    field = pedsim_msgs__msg__agent_force__convert_to_py(&ros_message->forces);
    if (!field) {
      return NULL;
    }
    {
